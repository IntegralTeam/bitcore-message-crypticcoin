...
bitcore-message-crypticcoin adds support for verifying and signing CrypticCoin messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-crypticcoin
```

```sh
bower install bitcore-message-crypticcoin
```
